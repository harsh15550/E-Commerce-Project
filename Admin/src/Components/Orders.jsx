...
const Orders = () => {
  ...
  const handleSearch = async () => {
    try {
      const response = await axios.get(`${url}/api/admin/search?name=${searchOrder}`, { withCredentials: true });
  ...
  const handleDelete = async (id) => {
    try {
      const response = await axios.delete(`${url}/api/admin/deleteOrder/${id}`, {withCredentials: true})
      if(response.data.success){
        toast.success(response.data.message)
